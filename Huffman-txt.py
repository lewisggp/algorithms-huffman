...
if __name__ == "__main__":
    ...
    # Mostrar el contenido decodificado por pantalla
    ...
    print("\nArchivo comprimido guardado como 'compressed_file.bin'")
    print("Archivo descomprimido guardado como 'decompressed_file.txt'")
